...
public class DBBlocks {
    private static final RegistrationProvider<Block> BLOCK_REGISTRY = RegistrationProvider.get(Registries.BLOCK, Constants.MODID);
    ...
    static {
        ...
        BlockBehaviour.Properties thatchProperties = Block.Properties.of().noCollission().forceSolidOff().replaceable().liquid().noCollission().randomTicks().strength(100.0F).noLootTable();
